<template>
    <div class="bigBox">
        ...
        <div class="box">
            <!-- 滑动盒子 -->
            <div class="pre-box"
                :style="{ transform: flag ? 'translateX(100%)' : 'translateX(0%)', backgroundColor: flag ? '#c9e0ed' : '#edd4dc' }"
                @click="toggle">
                <h1>WELCOME</h1>
                <p>JOIN US!</p>
                <div class="img-box">
                    <img :src="flag ? image1 : image2" />
                </div>
            </div>
            <!-- 注册盒子 -->
...
import { ref } from 'vue';
import image1 from './assets/wuwu.jpeg';
import image2 from './assets/waoku.jpg';
const flag = ref(true);
