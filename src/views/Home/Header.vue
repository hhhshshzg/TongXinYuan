...
<template>
  <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false" @select="handleSelect">
    ...
    <el-menu-item index="3"> <router-link class="link" to="/login">动漫</router-link> </el-menu-item>
    <el-menu-item index="4"> <router-link class="link" to="/">问答</router-link> </el-menu-item>
    <!-- 登录注册 -->
    <router-link class="link" to="/PersonalHomepage">登录</router-link> |
    <router-link class="link" to="/hello">欢迎界面</router-link>
  </el-menu>
</template>
